...
static void recurse_inorder (struct _tree *n,
...
void
tree_insert (tree ** a, char *symbol, char *name, size_t price)
{
  if (!a)
    {
      return;
...
void
tree_inorder (tree * t, void (*func) (char *, char *, size_t *))
{
  if (!t)
    {
      return;
...
static void
recurse_inorder (struct _tree *n, void (*func) (char *, char *, size_t *))
{
  if (!n)
    {
      return;
